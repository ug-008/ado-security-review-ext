...
import SecurityReviewComponent from '../../Components/SRComponent/SRComponent'
...
describe('SRComponent', () => {
    ...
    test('SecurityReviewComponent - rendering', () => {

        render(<SecurityReviewComponent />);
        const textElement = screen.getByText(/Click me to change title!/i);
        expect(textElement).toBeDefined();

    });

    test('SecurityReviewComponent - click button', async() => {
    ...
    test('SecurityReviewComponent - onFieldChanged', async() => {
    ...
    test('SecurityReviewComponent - onLoaded', async() => {
    ...
    test('SecurityReviewComponent - onUnloaded', async() => {
    ...
    test('SecurityReviewComponent - onSaved', async() => {
    ...
    test('SecurityReviewComponent - onReset', async() => {
    ...
    test('SecurityReviewComponent - onRefreshed', async() => {
